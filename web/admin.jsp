	  ...
	  <script type="text/javascript">
		  $(document).ready(function(){
			  $("#next").click(function () {
				  ...
				  currentPage++;
				  location.href = "/admin?&state=0&page="+currentPage;
			  })
			  ...
			  $("#first").click(function () {
				  ...
				  location.href = "/admin?&state=0&page=1"
			  })
			  ...
			  $("#last").click(function () {
				  ...
				  location.href = "/admin?&state=0&page="+pages;
			  })
		  })
	  </script>
  </head>
		...
		<table class="table" cellspacing="0">
			...
			<c:forEach items="${borrowList}" var="borrow">
				<tr>
					...
					<td>
						<a href="/admin?method=handle&borrowID=${borrow.id}&state=1">同意</a>
						<a href="/admin?method=handle&borrowID=${borrow.id}&state=2">拒绝</a>
					</td>
				</tr>
			</c:forEach>
